...
| 3 | Verification mechanisms        | 🟡    | PHP side complete: phpcs (WordPress-Extra), phpstan level 5 + WP extension, phpunit scaffolded; `composer ci` green. Still missing: eslint, stylelint, prettier, smoke.sh. |
